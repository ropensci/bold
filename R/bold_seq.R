                    ...
                    researchers = NULL, geo = NULL, marker = NULL, callopts=list()) 
{
  ...
  args <- compact(list(taxon=taxon, geo=geo, ids=ids, bin=bin, container=container, 
                       institutions=institutions, researchers=researchers, marker=marker))
